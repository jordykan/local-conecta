...
export const metadata = {
  title: "Panel de Administración | Mercadito",
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">
          Gestiona negocios, categorías y estadísticas de la plataforma
        </p>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-medium text-orange-900">
                Hay {stats.pendingBusinesses}{" "}
                {stats.pendingBusinesses === 1
                  ? "negocio pendiente"
                  : "negocios pendientes"}{" "}
                de aprobación
              </p>
              <p className="text-sm text-orange-700">
                Revisa y aprueba los negocios registrados
              </p>
            </div>
            <Link
      ...
      <AdminRecentBusinesses
        businesses={pendingBusinesses?.slice(0, 5) ?? []}
      />
    </div>
  );
}
